...
// let arr1 = ['school is cool', false, [1,2,3], {keyA: 'green', keyB: 'yellow', keyC: 'blue'}, 13];

// console.log(arr1[0]);

// for (let thing of arr1); //thing represents values for-of represents 
// console.log(thing);
...
/*
Challenge 2:
Build an array with the values: 'swimming', 'running', 'yoga', 'biking', 'climbing'.  Add the value 'stretching' with 'splice', but don't remove any contents in the array.  Add the value 'basketball' with 'splice', but *do* remove one element.  Finally, use 'slice' to cut and save a portion of your array to a separate variable.  Use console.logs between every 'splice' or 'slice' to confirm that your array is changing as you expect it to.*/

// let newArr = ['swimming', 'running', 'yoga', 'biking', 'climbing'];

// newArr.splice(0, 0, 'stretching');
// console.log(newArr);
// newArr.splice(0,3,'basketball');
// console.log(newArr);
// let secondArr = newArr.slice(1,3);
